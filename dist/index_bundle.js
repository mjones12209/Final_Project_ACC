...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _keys_keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../keys/keys */ "./keys/keys.js");
...
var populateGenre = function populateGenre() {
  var options = {
    method: 'GET',
    url: "https://api.themoviedb.org/3/genre/movie/list?api_key=".concat(_keys_keys__WEBPACK_IMPORTED_MODULE_0__.apiKEY, "&language=en-US") };
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default().request(options).then(function (response) {
    ...
    response.data.genres.forEach(function (element) {
      ...
      dropDownShow.insertAdjacentHTML("beforeend", a);
